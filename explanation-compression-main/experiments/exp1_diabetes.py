...
model = xgboost.XGBRegressor(max_depth=4, subsample=0.9**3, colsample_bytree=0.9, colsample_bylevel=0.9, colsample_bynode=0.9, alpha=0.1)
model.fit(X, y)
...
exp_results.to_csv("results/exp1_diabetes.csv", index=False)
